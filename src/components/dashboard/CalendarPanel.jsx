...
function DayCell({ day, rec, isToday, isSelected, onClick, headacheScores, filters }) {
  ...
  return (
    ...
    >
      ...
      {showMig && (
        <div style={{ position: "absolute", top: -5, left: -3, width: 13, height: 13, borderRadius: "50%", overflow: "hidden", zIndex: 10 }}>
          <img src="/icons/ico_prevented.png" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
        </div>
      )}
      {showCluster && (
...
export default function CalendarPanel({
  ...
  return (
    <div>
      {/* Month nav */}
      <div className="flex items-center justify-between mb-4" style={{ width: 244 }}>
      ...
      {/* Filter checkboxes */}
      <div className="mt-4 pt-3 flex flex-wrap gap-x-4 gap-y-2" style={{ borderTop: "1px solid rgba(74,122,181,0.1)", width: 244 }}>
